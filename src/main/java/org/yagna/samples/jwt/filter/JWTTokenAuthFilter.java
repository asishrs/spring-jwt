...
import org.yagna.samples.jwt.exception.AuthenticationException;
...
public class JWTTokenAuthFilter extends OncePerRequestFilter {
    private static List<Pattern> AUTH_ROUTES = new ArrayList<Pattern>();
    private static List<String> NO_AUTH_ROUTES = new ArrayList<String>();
...
//        }
        ...
        if (needsAuthentication) {
            ...
            try {
                ...
                throw new AuthenticationException("Invalid token. Cause:"+e.getMessage());
            }
        } else {
            filterChain.doFilter(request, response);
        }
